          ...
          <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-tools">
                  <form action="{{ route('admin#userSearch')}}" method="post">
                    ...
                    <div class="input-group input-group-sm my-auto" style="width: 150px;">
                        <input type="text" name="searchUser" class="form-control float-right" value="" placeholder="Search">
              ...
              <div class="card-body table-responsive p-0">
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin#userDelete',$items->id)}}" class="text-decoration-none">
                ...
                <div class="mt-4 text-center">{{$userData->links()}}</div>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
