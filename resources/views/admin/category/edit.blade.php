                    ...
                    <div class="active tab-pane" id="activity">
                      ...
                      <form class="form-horizontal" method="POST" action="{{ route('admin#updateCategory')}}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{ old('name', $oldData->category_name)}}" id="inputName" name="name"  placeholder="Name">
                            {{-- @if($errors->has('name'))
                        ...
                        <div class="form-group row">
                          <div class="offset-sm-2 col-sm-10">
                            ...
                            <input type="text" hidden name="id" value="{{ $oldData->category_id}}" id="">
